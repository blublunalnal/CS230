...
def log_to_csv(args, meta_metrics, note, threshold_used):
    """
...
def test(model, dataloader, args, meta_threshold=0.5):
    ...
    log_to_csv(args, meta_metrics_bag, note="PER BAG LEVEL", threshold_used=meta_threshold)
    ...
    log_to_csv(args, meta_metrics_patient, note="PER PATIENT LEVEL", threshold_used=meta_threshold)
